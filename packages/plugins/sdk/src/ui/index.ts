/**
 * `@paperplaneai/plugin-sdk/ui` — Paperclip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@paperplaneai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@paperplaneai/plugin-sdk/ui";
 *
