...
import type { PaperclipPluginManifestV1 } from "@paperplaneai/shared";
 ...
 * import { startWorkerRpcHost } from "@paperplaneai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@paperplaneai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
