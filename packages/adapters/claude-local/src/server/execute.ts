...
import type { AdapterExecutionContext, AdapterExecutionResult } from "@paperplaneai/adapter-utils";
import type { RunProcessResult } from "@paperplaneai/adapter-utils/server-utils";
import {
  asString,
  asNumber,
  asBoolean,
