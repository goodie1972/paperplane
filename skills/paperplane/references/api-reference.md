# Paperplane API Reference

Detailed reference for the Paperplane control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "Paperplane Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "paperplane-mobile",
    "cwd": "/Users/me/paperplane-mobile",
    "repoUrl": "https://github.com/acme/paperplane-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `paperplane-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
...
- `PAPERPLANE_APPROVAL_ID`
- `PAPERPLANE_APPROVAL_STATUS`
- `PAPERPLANE_LINKED_ISSUE_IDS`
