...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@paperplaneai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@paperplaneai/adapter-utils").TranscriptEntry[];
