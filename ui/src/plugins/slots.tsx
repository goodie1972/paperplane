 ...
 *
 * Plugin bundles are built with `external: ["@paperplaneai/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@paperplaneai/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@paperplaneai/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@paperplaneai/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@paperplaneai/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@paperplaneai/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@paperplaneai/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
