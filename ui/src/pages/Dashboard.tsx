...
import type { Agent, Issue } from "@paperplaneai/shared";
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? `${data.costs.monthUtilizationPercent}% ${t("dashboard.budgetOf")} ${formatCents(data.costs.monthBudgetCents)} ${t("dashboard.budget")}`
