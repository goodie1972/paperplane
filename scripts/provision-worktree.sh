...
base_cwd="${PAPERPLANE_WORKSPACE_BASE_CWD:?PAPERPLANE_WORKSPACE_BASE_CWD is required}"
worktree_cwd="${PAPERPLANE_WORKSPACE_CWD:?PAPERPLANE_WORKSPACE_CWD is required}"
