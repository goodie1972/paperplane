...
- `PAPERPLANE_APPROVAL_ID` — the resolved approval
- `PAPERPLANE_APPROVAL_STATUS` — `approved` or `rejected`
- `PAPERPLANE_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
