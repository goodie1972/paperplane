...
Paperplane supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Paperplane?** Use `local_trusted` (the default)
