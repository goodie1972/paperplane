...
- `skills/paperplane/SKILL.md` and `skills/paperplane/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.1 `skills/paperplane/SKILL.md`
...
## 6.2 `skills/paperplane-create-agent/SKILL.md`
