...
- installed adapter list for this Paperplane instance
...
## 8. New Skill: `paperplane-create-agent`

Create new skill directory:

- `skills/paperplane-create-agent/SKILL.md`
...
Also update `skills/paperplane/SKILL.md` to reference this skill for hiring workflows.
...
- `paperplane-create-agent` skill + docs updates
