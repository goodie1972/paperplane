...
export async function doctor(opts: {
  ...
  p.intro(pc.bgCyan(pc.black(" paperplane doctor ")));
  ...
  try {
    ...
    const readResult: CheckResult = {
      ...
      canRepair: false,
      repairHint: "Run `paperplaneai configure --section database` or `paperplaneai onboard`",
    };
...
async function runRepairableCheck(input: {
  ...
  loadPaperplaneEnvFile(input.configPath);
