...
import type { Db } from "@paperplaneai/db";
import { agents as agentsTable, companies, heartbeatRuns } from "@paperplaneai/db";
...
import { runClaudeLogin } from "@paperplaneai/adapter-claude-local/server";
import {
  DEFAULT_CODEX_LOCAL_BYPASS_APPROVALS_AND_SANDBOX,
  DEFAULT_CODEX_LOCAL_MODEL,
} from "@paperplaneai/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@paperplaneai/adapter-cursor-local";
import { DEFAULT_GEMINI_LOCAL_MODEL } from "@paperplaneai/adapter-gemini-local";
import { ensureOpenCodeModelConfiguredAndAvailable } from "@paperplaneai/adapter-opencode-local/server";
